...
const jobsEndpoints = {
    ...
    fetchJob: `${baseURL}/jobs/fetch_jobs`,
    fetchRoutes: `${baseURL}/jobs/fetch_routes`,
    updateJobStatus: `${baseURL}/jobs/update_job_status`,
    sendNotification: `${baseURL}/jobs/send_notification`,
}
...
export {dashboardEndpoints, authEndpoints, uploadEndpoints, contentEndpoints, settingsEndpoints, jobsEndpoints, optionsEndpoints, billingEndpoints};