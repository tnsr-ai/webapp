    ...
    <div>
      ...
      <div id="billing-tab">
        <div className="flex-row xl:flex mt-5 px-6 gap-5 ">
          <div className="bg-purple-200 rounded-xl md:flex-[6] min-h-[200px] shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            <div className="flex flex-col items-start justify-start h-full">
              ...
              <div className="flex flex-row gap-10">
                <h1 className="text-left font-normal text-base md:text-lg pt-5 pl-5">
                  Current Balance: <br className="block sm:hidden" />{" "}
                  <span className="font-semibold">
                    {props.data.data.balance} credits
                  </span>
                </h1>
                <h1 className="text-left font-normal text-base md:text-lg pt-5 pl-5">
                  Lifetime Usage: <br className="block sm:hidden" />{" "}
                  <span className="font-semibold">
